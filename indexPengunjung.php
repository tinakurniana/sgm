...
<head>
    ...
    <!-- Favicon -->
    <link href="assets-pengunjung/img/favicon.ico" rel="icon">
    ...
    <link href="assets-pengunjung/lib/animate/animate.min.css" rel="stylesheet">
    <link href="assets-pengunjung/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    <link href="assets-pengunjung/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css" rel="stylesheet" />

    <!-- Customized Bootstrap Stylesheet -->
    <link href="assets-pengunjung/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="assets-pengunjung/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                ...
                <!-- <img src="assets-pengunjung/img/logo.png" alt="Logo"> -->
            </a>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="assets-pengunjung/img/about-1.jpg" alt="" style="object-fit: cover;">
                    </div>
                </div>
    ...
    <script src="assets-pengunjung/lib/wow/wow.min.js"></script>
    <script src="assets-pengunjung/lib/easing/easing.min.js"></script>
    <script src="assets-pengunjung/lib/waypoints/waypoints.min.js"></script>
    <script src="assets-pengunjung/lib/owlcarousel/owl.carousel.min.js"></script>
    <script src="assets-pengunjung/lib/tempusdominus/js/moment.min.js"></script>
    <script src="assets-pengunjung/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="assets-pengunjung/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
