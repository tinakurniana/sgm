...
if (isset($_POST['login'])) {
	if ($_POST['role'] == 'admin') {
		...
		if (count($data) > 0) {
			...
			echo '<script>
				alert("Login Berhasil");
				location.href = "indexAnggota.php";
			</script>';
		} else {
			echo '<script>
				alert("Login Gagal");
...
<head>
	...
	<!--ace styles-->
	<link rel="stylesheet" type="text/css" href="assets-admin/css/ace.min.css" />
	<link rel="stylesheet" type="text/css" href="assets-admin/css/ace-rtl.min.css" />
</head>
