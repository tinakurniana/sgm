			...
			<div class="modal-content">
				<form class="form-horizontal" method="POST" role="form">
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-primary" value="<?= $id?>" name="btn-tambah">Tambah</button>
									...
									<tr>
										...
										<td class="center">
											<div class="action-buttons">
												...
												<a data-rel="tooltip" data-placement="top" title="Detail Bulan" oclass="red tooltip-infp" href="indexAdmin.php?p=simpanan-wajib&id=<?= $value['id'] ?>">
